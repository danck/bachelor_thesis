...
\end{table}
\footnotetext{Siehe Anhang Listing~\ref{lst:measure_network}}
...
\begin{enumerate}
	...
	\subitem u.a.\footnote{Bei den sparkspezifischen Messgrößen gibt es noch weitere, die nicht in die Auswertungen einbezogen wurden.}
\end{enumerate}
...
\begin{itemize}
	...
	\item Arbeitsspeicher pro Executor		: 384 MB
\end{itemize}
...
Eine laufende Anwendung startet auf dem Host des Treibers eine Weboberfläche (siehe Abb.~\ref{figure:realtime_dashboard_stats}), die den aktuellen Verlauf des Programms verfolgen lässt. Zusätzlich werden Daten über Verteilung
