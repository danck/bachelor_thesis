...
\HAWThesisProperties{Author={Daniel Kirchner}
                    ,Title={Skalierbare Datenanalyse mit Apache Spark}
										,SubTitle={Implementation einer Text-Mining-Anwendung und Testbetrieb auf einem Low-End-Cluster}
                    ,EnglishTitle={Scalable Data Analysis with Apache Spark}
										,EnglishSubTitle={Implementation of a Text Mining Application and Test Operation on a Low-End Cluster}
										,SubTitleDelimiter={: }
