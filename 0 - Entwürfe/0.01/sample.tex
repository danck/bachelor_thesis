...
Map-Reduce als Programmierparadigma zur effizienten Verarbeitung großer Datenmengen zeigt jedoch in vielen Anwendungsfällen Schwächen:
\begin{itemize}
...
%%\begin{figure}[htbp]
  %%\centering
  \includesvg[clean,width=100pt,height=100pt]{versuchsaufbau}
%%  \caption{svg image}
%%\end{figure}
