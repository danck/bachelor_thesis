...
Eine typische Anwendung mit verteilten lokalem Storage (HDFS) und Spark als "`Client"' eines bestehenden Yarn Clustermanagers. Commodity Hardware (Rasperry Pi Cluster).
...
\section{Beispiel 1 - Hot Topics in der Spark Community}
Fusion von Tweets und Mailinglisten 
...
Implementation ausgewählter CDOs (sehr wenige, möglicherweise nur 1-2) mit der Core-API von Spark. Testlauf auf einem HPC Cluster mit nicht-lokalem, allerdings per Infiniband angeschlossenen Storage.
