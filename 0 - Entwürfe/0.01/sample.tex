...
\caption[Google Trends]{Vergleich der Suchanfragen von Spark und Hadoop auf Google}
\end{figure}
...
Diese API (für die Sprachen Scala, Java und Python verfügbar), kann im einfachsten Fall über eine eigene Spark Konsole mit REPL-Pattern [\cite{Hail}] verwendet werden.\\
Eine Zählung von Wortvorkommen - das "`Hello World"' der Big Data Szene - lässt sich dort mit zwei Befehlen realisieren:\\
...
Aus Sicht eines Administrators ist Apache Spark eine Applikation auf einem Rechencluster, die sich in der Anwendungsschicht befindet und charakteristische Anforderungen insbesondere an Lokalität des Storages und Netzwerkperformance stellt.\\
