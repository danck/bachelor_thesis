...
\begin{figure}[ht!]
	\centering
  \includegraphics[scale=0.7]{lineage_basic.pdf}
...
\begin{figure}[ht!]
	\centering
  \includegraphics[scale=0.7]{lineage_parted.pdf}
...
\begin{figure}[ht!]
	\centering
  \includegraphics[scale=0.7]{lineage_stages.pdf}
...
Die Spark SQL Bibliothek bietet Schnittstellen für den Zugriff auf strukturierte Daten in Form klassischer SQL-Abfragen. Dazu wird eine Abstraktion der \glspl{rdd} eingeführt. Diese Abstraktion sind Dataframes wie sie aus der Programmiersprache R bekannt sind.\\

\begin{labeling}{Anmerkung:~}
\item[\textbf{Data Frames}:] \lipsum[1]
\end{labeling}
