...
\textbf{\textit{Transformationen}} sind Operationen, die ein \gls{RDD} auf ein anderes abbilden ohne dabei Elemente untereinander zu verknüpfen oder Elemente exportieren (z.B. zu Datenbanken, Dateisysteme, Messaging Systeme, dem Treiberprogramm).\\
