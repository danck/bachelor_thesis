...
\caption{Word Count in der Spark Konsole}
\label{lst:sconsole_wordcount}
...
\lstinline|val text = sc.textFile("../Heinrich Heine - Der Ex-Lebendige")|\\
...
Ein möglicher Vorteil dieser Art von Arbeitsdatensatz wird sofort deutlich: Im optimalen Fall sind die zu ladenden Daten bereits gleichmäßig über den lokalen Festspeicher der \gls{worker} partitioniert.
